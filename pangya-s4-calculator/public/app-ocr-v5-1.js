(() => {
  ...
  async function runOCR() {
    ...
    try{
      ...
      // Calibration mode for the current calculator.
      $('shot').value='1';$('spin').value='9';$('curve').value='0';$('slope_break').value='0';
  ...
  // Spin is part of this player's profile, not the selected wood.
